...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'personas', loadChildren: './Forms/person/person.module#PERSONModule', canActivate: [AuthGuard] },
            { path: 'inmueble', loadChildren: './Forms/inmueble/inmueble.module#InmuebleModule', canActivate: [AuthGuard] },
            { path: 'parqueadero', loadChildren: './Forms/parqueadero/parqueadero.module#ParqueaderoModule', canActivate: [AuthGuard] }
        ]
    }
];
