...
@Component({
	selector: 'app-parqueaderoTable',
	templateUrl: './parqueaderoTable.component.html',
	styleUrls: ['./parqueaderoTable.component.scss']
})
export class ParqueaderoTableComponent implements OnInit {
	...
	delete(item) {
		...
		console.log('JSON CANCELAR ' + item['eliminar']);
		swal({
